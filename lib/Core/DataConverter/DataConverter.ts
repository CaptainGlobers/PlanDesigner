...
export class DataConverter {
    ...
    public static getJson(levels: Array<ILevel>): string {
        ...
        let zeroPoint = levels[1].objects[0] ? new Point(levels[1].objects[0].point1) : new Point(0, 0);
        const getZeroShape = (shapes: Array<IShape>): void => {
            if (shapes) {
        ...
        const getShapes = (shapes: Array<IShape>): any => {
